...
2. For convenience, a subset of [Taxi](/datasets/) dataset is made available in this repo that can be readily used for launching XGBoost job. Use [ETL](#launch-mortgage-or-taxi-etl-part) to generate larger datasets for training and testing.
