...
2. Import the example notebook: [XGBoost4j-Spark mortgage notebook](/examples/ETL+XGBoost-Examples/mortgage/notebooks/scala/mortgage-gpu.ipynb)
...
See supported configuration options here: [xgboost parameters](/examples/ETL+XGBoost-Examples/app-parameters/supported_xgboost_parameters_python.md)
