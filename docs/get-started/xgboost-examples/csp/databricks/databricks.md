...
2. Import the example notebook: [XGBoost4j-Spark mortgage notebook](/examples/Spark-ETL+XGBoost(splitting)/mortgage/notebooks/scala/mortgage-gpu.ipynb)
...
See supported configuration options here: [xgboost parameters](/examples/Spark-ETL+XGBoost(splitting)/app-parameters/supported_xgboost_parameters_python.md)
