...
For Spark-RAPIDS-ML version 25.02.1, download the RAPIDS jar from Maven Central: [rapids-4-spark_2.12-25.02.1.jar](https://repo1.maven.org/maven2/com/nvidia/rapids-4-spark_2.12/25.02.1/rapids-4-spark_2.12-25.02.1.jar). 
