...
[rapids-4-spark_2.12-23.08.0.jar](https://repo1.maven.org/maven2/com/nvidia/rapids-4-spark_2.12/23.08.0/rapids-4-spark_2.12-23.08.0.jar)
...
3. Install a new kernel with the jar(use $RAPIDS_ML_JAR for reference) built from section [Build](#build) and launch
    ...
    PLUGIN_JAR=PATH_TO_rapids-4-spark_2.12-23.08.0.jar
